...
const HeaderCat = () => {
    return(
        <div className="w-full mt-3 mb-96 overflow-hidden lg:mt-7">
            ...
            <div className="mobit-category w-full flex pb-5 overflow-auto md:justify-between ">
                <div className="phone cursor-pointer flex flex-col justify-center items-center gap-2 text-[14.4px] xl:text-[15.5px] text-[#323436] group">
                    <div className="bg-[#f5f5f5] mx-5 md:mx-0 w-16 h-16 rounded-2xl"> <img className="w-16 h-16 lg:w-[72px] lg:h-[72px] group-hover:scale-110 transition-all duration-300" src={phone} alt="" /> </div>
                ...
                <div className="phoneStuff cursor-pointer flex flex-col justify-center items-center gap-2 text-[14.4px] xl:text-[15.5px] text-[#323436] group">
                    <div className="bg-[#f5f5f5] mx-5 md:mx-0 w-16 h-16 rounded-2xl"> <img className="w-16 h-16 lg:w-[72px] lg:h-[72px] group-hover:scale-110 transition-all duration-300" src={phoneStuff} alt="" /> </div>
                ...
                <div className="computer cursor-pointer flex flex-col justify-center items-center gap-2 text-[14.4px] xl:text-[15.5px] text-[#323436] group">
                    <div className="bg-[#f5f5f5] mx-5 md:mx-0 w-16 h-16 rounded-2xl"> <img className="w-16 h-16 lg:w-[72px] lg:h-[72px] group-hover:scale-110 transition-all duration-300" src={computer} alt="" /> </div>
                ...
                <div className="laptop cursor-pointer flex flex-col justify-center items-center gap-2 text-[14.4px] xl:text-[15.5px] text-[#323436] group">
                    <div className="bg-[#f5f5f5] mx-5 md:mx-0 w-16 h-16 rounded-2xl"> <img className="w-16 h-16 lg:w-[72px] lg:h-[72px] group-hover:scale-110 transition-all duration-300" src={laptop} alt="" /> </div>
                ...
                <div className="tablet cursor-pointer flex flex-col justify-center items-center gap-2 text-[14.4px] xl:text-[15.5px] text-[#323436] group">
                    <div className="bg-[#f5f5f5] mx-5 md:mx-0 w-16 h-16 rounded-2xl"> <img className="w-16 h-16 lg:w-[72px] lg:h-[72px] group-hover:scale-110 transition-all duration-300" src={tablet} alt="" /> </div>
                ...
                <div className="powerBanks cursor-pointer flex flex-col justify-center items-center gap-2 text-[14.4px] xl:text-[15.5px] text-[#323436] group">
                    <div className="bg-[#f5f5f5] mx-5 md:mx-0 w-16 h-16 rounded-2xl"> <img className="w-16 h-16 lg:w-[72px] lg:h-[72px] group-hover:scale-110 transition-all duration-300" src={powerBanks} alt="" /> </div>
                ...
                <div className="airpods cursor-pointer flex flex-col justify-center items-center gap-2 text-[14.4px] xl:text-[15.5px] text-[#323436] group">
                    <div className="bg-[#f5f5f5] mx-5 md:mx-0 w-16 h-16 rounded-2xl"> <img className="w-16 h-16 lg:w-[72px] lg:h-[72px] group-hover:scale-110 transition-all duration-300" src={airpods} alt="" /> </div>
                ...
                <div className="smartWatch cursor-pointer flex flex-col justify-center items-center gap-2 text-[14.4px] xl:text-[15.5px] text-[#323436] group">
                    <div className="bg-[#f5f5f5] mx-5 md:mx-0 w-16 h-16 rounded-2xl"> <img className="w-16 h-16 lg:w-[72px] lg:h-[72px] group-hover:scale-110 transition-all duration-300" src={smartWatch} alt="" /> </div>
